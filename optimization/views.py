...
def about(request):
    return render(request, 'optimization/about.html')

def ourTeam(request):
    return render(request, 'optimization/ourTeam.html')

def smartTrucks(request):
    return render(request, 'optimization/smart_trucks.html')
...
def solve(request):
    if request.method == 'POST':
        ...
        for i in range(num_trucks):
            ...
            trucks.append({'optimal_value': optimal_value, 'selected_goods': selected_goods,'path': shortest_path, 'distance': shortest_distance})
                
        return render(request, 'optimization/results.html', {'trucks':trucks})
    else:
